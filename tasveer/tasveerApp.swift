...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupMenuBar() {
        ...
        if let statusButton = statusItem?.button {
            statusButton.image = NSImage(systemSymbolName: "camera.viewfinder", accessibilityDescription: "Tasveer")
    ...
    private func setupMenuBarMenu() {
        ...
        menu.addItem(NSMenuItem.separator())
        menu.addItem(NSMenuItem(title: "Quit Tasveer", action: #selector(NSApp.terminate(_:)), keyEquivalent: "q"))
